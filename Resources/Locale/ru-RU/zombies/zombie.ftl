...
zombie-infection-greeting = Вы стали зомби. Ваша задача - искать и заражать живых. Работайте сообща со другими зомби, чтобы захватить станцию.
zombie-generic = зомби
zombie-name-prefix = Зомбифицированный {$target}

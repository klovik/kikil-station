...
air-alarm-ui-access-denied = Недостаточный доступ!
...
air-alarm-ui-window-resync-devices-label = Обновить
...
air-alarm-ui-mode-filtering = Фильтр
air-alarm-ui-mode-wide-filtering = Фильтр (широкий)
...
air-alarm-ui-widget-copy-tooltip = Копирует настройки этого устройства на все устройства на этой вкладке воздушной тревоги.
...
air-alarm-ui-scrubber-wide-net-label = Широкая Сеть

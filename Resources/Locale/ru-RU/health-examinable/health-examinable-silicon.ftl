health-examinable-silicon-none = Видимые повреждения отсутствуют.
...
health-examinable-silicon-Slash-50 = [color=crimson]{ CAPITALIZE(POSS-ADJ($target)) } { CONJUGATE-HAVE($target) } крайне серьёзные и глубокие царапины![/color]

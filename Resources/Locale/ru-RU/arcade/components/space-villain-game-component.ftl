...
space-villain-game-player-heal-message = Вы используете {$magicPointAmount} магии, чтобы исцелиться на {$healAmount}!
space-villain-game-player-recharge-message = Вы получаете {$regainedPoints} очков
...
space-villain-game-enemy-heals-message = {$enemyName} восстанавливает {$healedAmount} здоровья!
space-villain-game-enemy-steals-player-power-message = {$enemyName} крадет {$stolenAmount} вашей силы!

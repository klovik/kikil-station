...
injector-component-inject-success-message = Вы вводите {$amount}u в {$target}!
injector-component-transfer-success-message = Вы перемещаете {$amount}u в {$target}.
injector-component-draw-success-message = Вы набираете {$amount}u из {$target}.

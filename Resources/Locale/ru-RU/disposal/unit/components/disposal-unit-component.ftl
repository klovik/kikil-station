...
disposal-unit-state-Flushed = Создание давления
disposal-unit-state-Pressurizing = Создание давления

# putting people in
disposal-unit-being-inserted = {CAPITALIZE($user)} пытается загнать вас в утилизационный блок!

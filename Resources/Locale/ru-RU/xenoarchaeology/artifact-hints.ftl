...
artifact-effect-hint-release = Выделение энергии
artifact-effect-hint-biochemical = Воздействие на биохимическую среду
artifact-effect-hint-destruction = Станционные разрушения
artifact-effect-hint-gun = Маленький ускоритель частиц
artifact-effect-hint-multitool = Конгломерат устройств
artifact-effect-hint-storage = Внутренная камера
artifact-effect-hint-drill = Зазубренный вращатель
artifact-effect-hint-soap = Смазанная поверхность
artifact-effect-hint-communication = Дальняя коммуникация
...
artifact-trigger-hint-examine = Изучение

# Psionic Effects
artifact-effect-hint-psionic = Ноосферное нарушение

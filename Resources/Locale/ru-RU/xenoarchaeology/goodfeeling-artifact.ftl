...
goodfeeling-artifact-9 = Вы чувствуете радость.
goodfeeling-artifact-10 = Вы боретесь с желанием улыбнуться.
goodfeeling-artifact-11 = Кожа вашей головы покалывает.
goodfeeling-artifact-12 = Мир кажется более ярким.
goodfeeling-artifact-13 = Всё выглядит более светлым.
goodfeeling-artifact-14 = Проблемы мира исчезают.

goodfeeling-artifact-drastic-1 = Вам хочется обнять каждого встречного!
goodfeeling-artifact-drastic-2 = Всё идёт великолепно!
goodfeeling-artifact-drastic-3 = Вы ощущаете эйфорию.
goodfeeling-artifact-drastic-4 = Вы ощущаете головокружение.
goodfeeling-artifact-drastic-5 = Вы так счастливы, что вам хочется петь и танцевать.
goodfeeling-artifact-drastic-6 = Вам кажется, что весь мир хочет помочь вам.
